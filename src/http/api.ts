...
export default {
  ...
  getCategory({query}:{query: string}) {
  ...
  // 添加商品
  addGoods({ name, category, pic, video, cover, originalPrice, presentPrice, discount, detail, spec, 
    introduction, company, stock, isNewGood, isHot, isRecommend, comment, isShow, sellDesc, productionDesc }:
    { name: string, category: string, pic?: string[], video?: string[], cover: string, originalPrice: string,
       presentPrice: string, discount: string[], detail: string, spec: string[], introduction: string, company: string, stock: string, isNewGood: boolean, isHot: boolean, isRecommend: boolean, comment: string[], isShow: boolean, sellDesc: string[], productionDesc: string[] }) {
  ...
  // 修改商品参数
  updateParams({ id, url, name, desc ,parentId}: { id: string, url: string, name: string, desc: string,parentId: string }) {
